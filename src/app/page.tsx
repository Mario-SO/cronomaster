              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap lg:flex-nowrap gap-2 mt-2">
                    <Badge className="rounded-sm bg-green-500" variant="secondary">Min: {formatTime(minTime)}</Badge>
                    <Badge className="rounded-sm bg-yellow-500" variant="secondary">Med: {formatTime(medTime)}</Badge>
                    <Badge className="rounded-sm bg-red-500" variant="secondary">Max: {formatTime(maxTime)}</Badge>
                  </div>
                </div>
              </div>
